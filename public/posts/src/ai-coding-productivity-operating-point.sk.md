...
|---|---|---|---|
| Peng et al. 2023 (GitHub/Microsoft) | 1 greenfield JS HTTP-server task; ~95 recruited / ~70 completers | **+55,8% rýchlejšie** (95% CI 21–89%) | vendor preprint, jeden toy task |
...
| Kontext *k* | 0,0 | 0,25 | 0,5 | 0,75 | 1,0 |
|---|---|---|---|---|---|
...
**Je číslo „55% faster" falošné?** Nie — je to reálny meraný výsledok, ale na jednom greenfield JavaScript tasku vo vendor (GitHub/Microsoft) preprinte s ~70 completermi a širokým CI (21–89%). Negeneralizuje na skúsených vývojárov v rozsiahlych známych codebasoch.
