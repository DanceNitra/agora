...
DATA = "agora_output/lab/data/locomo10.json"
CACHE = "agora_output/lab/data/locomo_embcache_v2.json"
...
json.dump(result, open("agora_output/lab/locomo_retrieval_map_result.json", "w"), indent=1)
print("\nsaved -> agora_output/lab/locomo_retrieval_map_result.json")
