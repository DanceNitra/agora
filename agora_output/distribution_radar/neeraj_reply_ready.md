...
Genuinely up for comparing notes properly. The runnable probes (the supersession replication + the eviction/freshness benchmark) and the mnemo core all live in our repo — easiest is GitHub: github.com/DanceNitra/agora (open an issue or a discussion there and I'll point you straight at them). Keen to compare on the same ground.
---
