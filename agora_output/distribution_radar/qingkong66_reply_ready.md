...
Both mechanisms ship in our open memory core (mnemo, MIT): https://github.com/DanceNitra/agora/tree/main/mnemo . I'll drop the two standalone runnable probes in a discussion thread on our repo so they're versioned and easy to lift as reference implementations — use them however suits Elina-Seed (a link or a vendored copy are both fine).
