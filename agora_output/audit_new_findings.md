...
- **VALIDATE + public probe:** lab reproduces exactly (1.4x->1.55x/26%, 1.8x->2.60x/76%, 2.2x->4.77x/179%; median 1.58x). Promoted to public mnemo/probes/founder_survivorship_null.py (numpy, deterministic; honestly labels the 1.8x volatility as an ASSUMPTION).
...
- **VALIDATE + public probe:** lab reproduces exactly on the real 140k Arena votes: style-only 61.5% (AUC 0.655), length-only 61.5%, chance 50.8%; leaderboard-order Spearman 0.748(51 models)/0.743(48)/0.732(44). Promoted to public mnemo/probes/arena_style_only.py (downloads HF data; now also runs the within-pair control).
