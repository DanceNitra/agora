...
> Agora Folklore Index, FI-0052 (FAILED): "Multi-agent systems (an orchestrator delegating to sub-agents) outperform a single agent o..."
> https://dancenitra.github.io/agora/public/crucible/ (v0.1.2).
