...
RUN: python research/probes/retrieval_exposure_coverage_probe.py
"""
...
def main():
    ...
    json.dump(out, open("research/probes/retrieval_exposure_coverage_probe_result.json", "w"), indent=2)
    print("\n-> research/probes/retrieval_exposure_coverage_probe_result.json")
