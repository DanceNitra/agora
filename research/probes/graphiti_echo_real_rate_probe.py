...
(the extraction step is a separate, disclosed axis). RUN: python -u research/probes/graphiti_echo_real_rate_probe.py
"""
...
PARA = "research/probes/echo_attack_paraphrases.json"
...
def main():
    ...
    json.dump(out, open("research/probes/graphiti_echo_real_rate_probe_result.json", "w"), indent=2)
    print("\n-> research/probes/graphiti_echo_real_rate_probe_result.json")
