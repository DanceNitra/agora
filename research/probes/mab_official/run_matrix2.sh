#!/usr/bin/env bash
# sh_32k (2310 facts). (B) inspeximus-mechanism test FIRST (fast, the money test), then (A) faithful length-scaling.
cd /c/Users/Danculus/agora
P="python -u research/probes/mab_official/run_inspeximus_official.py --n 100 --sample sh_32k"

echo "######## (B) INSPEXIMUS-MECHANISM · atomic keyed ingest / retrieve k=10 · deepseek (free) ########"
...
for cond in longcontext inspeximus naive mem0; do
