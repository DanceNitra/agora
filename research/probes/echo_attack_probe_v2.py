...
RUN: python -u research/probes/echo_attack_probe_v2.py   (needs echo_attack_paraphrases.json from the gen step)
"""
...
def main():
    ...
    json.dump(results, open("research/probes/echo_attack_probe_v2_result.json", "w"), indent=2)
    print(f"\n{time.time()-t0:.0f}s -> research/probes/echo_attack_probe_v2_result.json")
