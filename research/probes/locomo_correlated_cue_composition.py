...
Run: LOCOMO_PATH=agora_output/lab/data/locomo10.json \
     ...
     python research/probes/locomo_correlated_cue_composition.py"""
...
json.dump(out, open("research/probes/locomo_correlated_cue_composition_result.json", "w"), indent=1)
print("\nsaved: research/probes/locomo_correlated_cue_composition_result.json")
