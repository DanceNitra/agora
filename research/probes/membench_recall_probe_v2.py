...
RUN: python research/probes/membench_recall_probe_v2.py   (local Ollama, nomic-embed-text)
"""
...
def main():
    ...
    json.dump(out, open("research/probes/membench_recall_probe_v2_result.json", "w"), indent=2)
    print(f"\ntotal {time.time()-t0:.0f}s -> research/probes/membench_recall_probe_v2_result.json")
