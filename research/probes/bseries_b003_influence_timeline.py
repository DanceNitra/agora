...
Run: python research/probes/bseries_b003_influence_timeline.py"""
...
m = Inspeximus()  # no embedder: supersession + corroboration gate are deterministic
rows = []
...
print("saved: research/probes/bseries_b003_influence_timeline_result.json")
...
print("saved: research/probes/bseries_b003_influence_timeline.csv")
