...
RUN (free):  python research/probes/integrity_bench_echo.py --systems mnemo
RUN (paid):  python research/probes/integrity_bench_echo.py --systems mnemo,mem0,graphiti --n 20
"""
