...
Run: LOCOMO_PATH=agora_output/lab/data/locomo10.json \
     ...
     python research/probes/locomo_soft_prefer_filter.py
"""
...
json.dump(out, open("research/probes/locomo_soft_prefer_filter_result.json", "w"), indent=1)
print("\nsaved: research/probes/locomo_soft_prefer_filter_result.json")
