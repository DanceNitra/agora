...
Run: LOCOMO_PATH=agora_output/lab/data/locomo10.json \
     ...
     python research/probes/locomo_composed_soft_filters.py
"""
...
json.dump(out, open("research/probes/locomo_composed_soft_filters_result.json", "w"), indent=1)
print("\nsaved: research/probes/locomo_composed_soft_filters_result.json")
