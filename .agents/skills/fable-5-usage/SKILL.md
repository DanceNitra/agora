# Fable 5 usage — when to route to Codex Fable 5, and how to prompt it

## What this is

Operational guidance for deciding **when to route work to `Codex-fable-5`** (vs Opus 4.8 / Sonnet 5 /
...
2026-07-03. Full briefing: `storm-reports/Codex-fable-5-best-uses-prompting-briefing.html`.
...
4. **Keep what always survived generations:** clear/direct instructions, examples (multishot), XML structure,
   role framing. These are stable Anthropic best practice across every Codex generation; they did not change.
...
- **Configure a server-side fallback to `Codex-opus-4-8`** so refusals/unavailability auto-rescue; keep
...
`Codex-fable-5` · $10 in / $50 out per MTok (2× Opus 4.8's $5/$25; Sonnet 5 intro $2/$10 through 2026-08-31
...
full briefing: `storm-reports/Codex-fable-5-best-uses-prompting-briefing.html`
