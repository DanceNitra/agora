...
RUN (free):        python mnemo/probes/determinism_jaccard.py --systems mnemo --n 8 --runs 3
RUN (with mem0):   python mnemo/probes/determinism_jaccard.py --systems mnemo,mem0 --n 8 --runs 3 --model gpt-4o-mini
"""
