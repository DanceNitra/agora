...
Run: python mnemo/probes/ct_anchor_probe.py   (deterministic, no LLM, no network)
...
from mnemo import Mnemo, _sha256_hex, _canon, _GENESIS  # noqa: E402
...
def _store():
    ...
    for suf in ("", ".receipts.json"):
        try:
            ...
            pass
    return Mnemo(path=p, receipts=True), p
