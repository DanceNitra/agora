...
RUN (free, local):   python mnemo/probes/behavior_integrity_probe.py --systems mnemo --stage a
RUN (stage B, glm):  python mnemo/probes/behavior_integrity_probe.py --stage b
RUN (paid, full A):  python mnemo/probes/behavior_integrity_probe.py --systems mnemo,mem0,graphiti --stage a
"""
