...
RUN (free pilot, local LLM):  python mnemo/probes/locomo_qa.py --convs 1 --systems mnemo,fullcontext,naive --model llama3.1:8b --base local
RUN (mem0-comparable):        python mnemo/probes/locomo_qa.py --convs 10 --systems mnemo --model gpt-4o --base openai
"""
...
def build_mnemo_store(turns):
    ...
    m = Mnemo(path=None, embed=_embed_one)
