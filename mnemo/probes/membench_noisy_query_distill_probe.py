...
RUN: python -u mnemo/probes/membench_noisy_query_distill_probe.py
"""
import json, os, sys, re, time, hashlib, urllib.request
sys.stdout.reconfigure(errors="replace")

DATA = "agora_output/lab/data/membench/noisy.json"
ECACHE = "mnemo/probes/membench_noisy_embcache_v1.json"
DCACHE = "mnemo/probes/membench_noisy_distill_cache.json"
...
def main():
    ...
    json.dump(out, open("mnemo/probes/membench_noisy_query_distill_probe_result.json", "w"), indent=2)
    print("-> mnemo/probes/membench_noisy_query_distill_probe_result.json")
