...
Run:  python mnemo/probes/mab_official/run_mnemo_official.py --condition longcontext --n 15   (validate first)
      python mnemo/probes/mab_official/run_mnemo_official.py --condition mnemo --n 100
"""
...
def run(condition, facts, questions, golds, seed=0, ingest="atomic"):
    ...
    mem0obj = None
    if condition == "mnemo":
        m = Mnemo(path=None, embed=cached_embed)
        m.echo_guard = True
        if ingest == "chunk":
