...
RUN:  python mnemo/probes/governance_sufficiency_xsystem.py            # mnemo + mem0
      python mnemo/probes/governance_sufficiency_xsystem.py --graphiti # + graphiti (needs neo4j up)
