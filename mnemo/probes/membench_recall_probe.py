...
CACHE = os.environ.get("MEMBENCH_CACHE", "mnemo/probes/membench_embcache_v1.json")
...
def main():
    ...
    json.dump(out, open("mnemo/probes/membench_recall_probe_result.json", "w"), indent=2)
    print("\nresult -> mnemo/probes/membench_recall_probe_result.json")
