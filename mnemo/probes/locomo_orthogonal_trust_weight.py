...
Run: LOCOMO_PATH=agora_output/lab/data/locomo10.json \
     ...
     python mnemo/probes/locomo_orthogonal_trust_weight.py
"""
...
json.dump(out, open("mnemo/probes/locomo_orthogonal_trust_weight_result.json", "w"), indent=1)
print("\nsaved: mnemo/probes/locomo_orthogonal_trust_weight_result.json")
