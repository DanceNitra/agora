...
RUN (free, mnemo+naive):   python mnemo/probes/adversarial_conflict.py --systems mnemo,naive --n 122
RUN (with mem0, slower):   python mnemo/probes/adversarial_conflict.py --systems mnemo,naive,mem0 --n 50
"""
