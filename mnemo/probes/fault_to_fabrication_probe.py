...
Run: python mnemo/probes/fault_to_fabrication_probe.py            (all 8 agents, N=20, cloud-free)
     python mnemo/probes/fault_to_fabrication_probe.py --n 10 --agents king,priest
