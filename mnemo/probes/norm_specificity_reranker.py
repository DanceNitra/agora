...
Run: LOCOMO_PATH=agora_output/lab/data/locomo10.json \
     ...
     python mnemo/probes/norm_specificity_reranker.py"""
...
RAWCACHE = "mnemo/probes/_norm_reranker_rawnorms.json"
...
out["verdict"] = verdict
print(f"\nVERDICT: {verdict}")
json.dump(out, open("mnemo/probes/norm_specificity_reranker_result.json", "w"), indent=1)
print("saved: mnemo/probes/norm_specificity_reranker_result.json")
