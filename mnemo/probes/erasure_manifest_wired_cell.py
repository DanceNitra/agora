...
Deterministic, judge-free (verbatim recovery), zero LLM. Uses the RELEASED mnemo 1.8.0 from mnemo-repo.
RUN: python mnemo/probes/erasure_manifest_wired_cell.py
"""
import os
import sys
import json
...
sys.path.insert(0, "C:/Users/Danculus/mnemo-repo")           # released product source (1.8.0)
from mnemo import Mnemo, __version__                          # noqa: E402
