...
`inspeximus` ships an MCP stdio server (`inspeximus-mcp`, 12 tools) as `inspeximus` on PyPI. This is the ready-to-submit
...
**Links:** repo https://github.com/DanceNitra/agora · PyPI https://pypi.org/project/inspeximus/ ·
