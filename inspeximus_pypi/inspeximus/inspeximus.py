...
def verify_erasure_certificate(cert: dict, store_path: str | None = None,
    ...
    """Independently verify a mnemo erasure certificate (from Inspeximus.erasure_certificate()). The AUDITOR's check:
...
class Inspeximus:
    def __init__(self, path: str | None = None, embed=None, receipts: bool = False,
        ...
        # research/probes/tenant_isolation_probe.py (measured cross-tenant leak 0/N).
        ...
        # current value is preserved. MEASURED (research/probes/echo_attack_probe_v2.py) on a MemBench echo
        ...
        # empty set. Receipt: research/probes/seed_anchored_trust_probe.py.
    ...
    def route(self, text: str, key: str | None = None, object: str | None = None,
        ...
        not a value). This ships the split measured in research/probes/intent_tagger_router_probe.py.
    ...
    def _bm25_scores(self, qtok: set, pool: list, k1: float = 1.5, b: float = 0.75) -> list:
        ...
        lexical channel that makes the hybrid beat either alone (research/probes/locomo_retrieval_map.py)."""
        N = len(pool)
        if N == 0:
            return []
    ...
    def recall(self, query: str, k: int = 6, include_superseded: bool = False,
        ...
        body / research/probes/locomo_retrieval_map.py). Force a single channel with mode='lexical' /
        ...
        research/probes/locomo_metadata_prefilter.py). A dict of field -> condition; a record must match ALL
        ...
        MEASURED (research/probes/agentpoison_influence_gate*.py) against a real AgentPoison-style single-
        ...
        — research/probes/oracle_separation_density.py) and the load-bearing caveat that it rides on an
        ...
        case). MEASURED (research/probes/locomo_soft_prefer_filter.py) on LoCoMo: soft prefer weighted by
        ...
        max_boost); default None = uncapped. MEASURED (research/probes/locomo_composed_soft_filters.py) on LoCoMo:
        ...
        research/probes/membench_recall_probe_v2.py). Pass a small similarity epsilon (measured sweet spot
        ...
        (research/probes/membench_recency_tiebreak_probe.py, 222 questions incl. 3 control splits):
        ...
        # MEASURED (research/probes/continuous_chunk_recall_probe.py): on a real TAT 5-D state trace, near-boost on
        ...
        # lexical->semantic at the threshold). Receipt: research/probes/locomo_retrieval_map.py. RRF needs no
    ...
    def _is_corroborated(rec: dict, by_id: dict, strict: bool = False, require_warrant: bool = False) -> bool:
        ...
        set. Measured: research/probes/minja_influence_gate.py (self-graded ASR 80% -> 0% with the flag on).
        ...
        the flag, so this is reversible; receipt research/probes/retraction_propagation.py.
    ...
    def influence_gate_report(self) -> dict:
        ...
        (research/probes/oracle_separation_density.py): the fraction of legitimate high-stakes recalls the gate
    ...
    def propagate_outcome(self, outcome, ids=None, weight: float = 1.0,
        ...
        a fundamental ceiling; research/probes/retrieval_exposure_coverage_probe.py + the outcome-propagation
        lift measured in research/probes/outcome_propagation_probe.py).
    ...
    def slash(self, ids, scope: str = "source") -> dict:
        ...
        motivation: research/probes/triad_attacker_split.py + reversibility_gate_frontier.py (the residual against a
    ...
    def spend_irreversible(self, ids, amount: float = 1.0, budget: float = 1.0,
        ...
        # research/probes/soft_influence_taint_probe.py.
